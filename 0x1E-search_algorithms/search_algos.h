...
int jump_search_helper(int *array, size_t size, int value, size_t step);
int interpolation_search_helper(int *array, size_t size, int value, size_t low, size_t high);
int exponential_search_helper(int *array, size_t size, int value, size_t bound);
